...
public class IdleState : ITicketMachineState
{
    ...
    public void InsertMoney(decimal amount) => throw new InvalidOperationException("Сначала выберите билет.");
    public void DispenseTicket() => throw new InvalidOperationException("Нет выбранного билета для выдачи.");
    public void Cancel() => throw new InvalidOperationException("Нечего отменять в состоянии ожидания.");
}
