...
public class WaitingForMoneyState : ITicketMachineState
{
    ...
    public void InsertMoney(decimal amount)
    {
        ...
        Console.WriteLine($"Внесено {amount:C}. Всего: {_context.Payments.CurrentBalance:C}");
    ...
    public void DispenseTicket() => throw new InvalidOperationException("Недостаточно средств или нет выбранного билета.");

    public void Cancel()
    {
        var returned = _context.Payments.ReturnChange();
        Console.WriteLine($"Отмена операции. Возвращено {returned:C}");
